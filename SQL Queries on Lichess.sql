#Want to determine the number of players in the dataset who didnt play in 2013, but played in 2014
...
#Compare the win rates of the top 5 players (by Elo) across both years and analyze if their 
#performance improved or worsened from 2013 to 2014.
select White, Black
from merged_2013_shortened
join combined_usernames_2013 cu2013
on a
;
